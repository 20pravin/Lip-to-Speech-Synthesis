...
def inv_linear_spectrogram(linear_spectrogram, hparams):
    ...
    def _denormalize(D, hparams):
        if hparams.allow_clipping_in_normalization:
            ...
            #the above code is in testing level , the accuracy level didn't meet our expectation.
            #hence we build the code for the speech to text synthesis, we have attached it with our github repository